...
CACHE="$HOME/.covers"
# API Key for Last.fm
APIKEY="bb335315d066a5522d8d00ef46789efc"
...
cp $HOME/.conky/nocover.png /tmp/conkyCover.png
echo "NoCover" >> $LOG
...
convert /tmp/cover.png $HOME/.conky/case.png -composite /tmp/cover.png >> $LOG
